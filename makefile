...
comp: COMPILER/main_comp.cpp $(SHAR_FILES) $(ASM_FILES)
	@echo "-----------------------------------------------------------------------------------------"
	g++ $(FLAGS) COMPILER/main_comp.cpp $(SHAR_FILES) $(ASM_FILES) $(SHAR_INCLUDES) $(GEN_INCLUDES) $(ASM_INCLUDES) -o comp_program
	@echo "-----------------------------------------------------------------------------------------"

spu: SPU/main_spu.cpp $(SHAR_FILES) $(SPU_FILES)
	@echo "-----------------------------------------------------------------------------------------"
	g++ $(FLAGS) SPU/main_spu.cpp $(SHAR_FILES) $(SPU_FILES) $(SHAR_INCLUDES) $(GEN_INCLUDES) $(SPU_INCLUDES) $(STK_INCLUDES) -o spu_program
	@echo "-----------------------------------------------------------------------------------------"
